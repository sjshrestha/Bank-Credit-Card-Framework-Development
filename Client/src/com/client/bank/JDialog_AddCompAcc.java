...
public class JDialog_AddCompAcc extends JDialog
{
	...
	public JDialog_AddCompAcc(BankGui parent)
	{
		super(parent);
		parentframe=parent;
	...
	{
		Party company = PartyFactory.getParty(JTextField_NAME.getText(),
				JTextField_EM.getText(),
				JTextField_STR.getText(),
				JTextField_CT.getText(),
				JTextField_ST.getText(),
				JTextField_ZIP.getText(),
				Integer.parseInt(JTextField_NoOfEmp.getText().trim().equals("") ?"0":JTextField_NoOfEmp.getText().trim()));
		...
		Account account = AccountFactory.getInstance().createAccount(type, JTextField_ACNR.getText());
		company.addAccount(account);
		parentframe.bank.setCustomer(company);

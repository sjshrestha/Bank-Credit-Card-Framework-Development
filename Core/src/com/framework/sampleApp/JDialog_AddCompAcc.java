...
{
    private SampleAppGui parentframe;
    
	public JDialog_AddCompAcc(SampleAppGui parent)
	{
		super(parent);
		parentframe = parent;
		...
		JTextField_ACNR.setText(Account.generateAccountNumber("ACC"));
		//}}
	...
	{
		System.out.println("Customer [company] has been created...");

		IOrganisation company = new SampleCompany();
		company.setName("Demo company");
		company.setEmail("email@demo.com");
		company.setState("Demo state");
		company.setCity("Demo city");
		company.setStreet("Demo street");
		company.setZip("012345");
		company.setNoOfEmployee(25);
		company.type = "SampleCompany";

		Account account = new SampleAccount("0123456789");
		company.addAccount(account);
		parentframe.sampleApp.setCustomer(company);

		parentframe.accountType = "Sample";

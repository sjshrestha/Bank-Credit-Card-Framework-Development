...
public class JDialog_AddPAcc extends JDialog
{
	...
	public JDialog_AddPAcc(SampleAppGui parent)
	{
		super(parent);
		parentframe = parent;
		...
		JTextField_ACNR.setText(Account.generateAccountNumber("ACP"));
	...
	{
		System.out.println("Customer [personal] has been created...");

		IPerson p = new SamplePerson();
		p.setName("Demo name");
		p.setEmail("email@demo.com");
		p.setState("Demo state");
		p.setCity("Demo city");
		p.setState("Demo state");
		p.setZip("Demo zip");
		p.type = "Personal";

		Account account = new SampleAccount("ACC-0123456789");
		account.setType("Savings");
		p.addAccount(account);

		parentframe.sampleApp.setCustomer(p);
